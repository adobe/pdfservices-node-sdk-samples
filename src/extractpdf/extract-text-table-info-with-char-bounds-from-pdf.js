...
/**
 * This sample illustrates how to extract Text and Table Information and char bounds for text data from PDF.
 * <p>
...
try {
    ...
    extractPDFOperation.execute(executionContext)
        .then(result => result.saveAsFile(createOutputFileDirectoryPath("output/ExtractTextTableInfoWithCharBoundsFromPDF",
            "Extract","zip")))
        .catch(err => {
